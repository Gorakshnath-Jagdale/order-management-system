...
public class ManagementService {
    ...
    public Customer createCustomer(Customer customer, int requesterUserId) throws Exception {
        if (!userManagementService.validateUser(requesterUserId)) throw new Exception("Invalid user request");
        if (customer != null) {
    ...
    public Product createProduct(Product request, int requesterUserId) throws Exception {
        if (request != null) {
            ...
            return productMapper.ProductDetailsEntityToProduct(savedCustomer);
        } else {
            throw new Exception("Invalid Input");
        }
    }
