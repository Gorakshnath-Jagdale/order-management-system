...
public class OrderManagementService {
    ...
    public  ByteArrayInputStream test(CustomerDetailsPojo customerDetails) throws IOException {
var orderManagerEntities=customerDetails.getCustomerOrders();
        ...
        powerHeaderRowOne.createCell(0).setCellValue(customerDetails.getCustomerName());
        ...
        headerRow.createCell(4).setCellValue("Customer Part No");
        ...
        headerRow.createCell(19).setCellValue("PO Image");
        for (int i = 0; i < 20; i++) {
            if(i<=13)
            {
        ...
        for (OrderManagerEntity order : orderManagerEntities) {
            ...
            row.createCell(3).setCellValue("test");//order.getCustomerDetails().getCustomerName()
            ...
            row.createCell(14).setCellValue(order.getSupplierDeliveryDate());
            ...
            row.createCell(19).setCellValue(order.getPoImageLink());
            for (int i = 0; i < 20; i++) {
